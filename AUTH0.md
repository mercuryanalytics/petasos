                ...
                <td class="pad-all-20">
                    ...
                    <table class="w100" cellspacing="0" cellpadding="0" border="0" align="center" width="600" style="width: 600px; min-width: 600px; margin: 0 auto;">
                        <tbody>
                                                                ...
                                                                <td style="background: #fff;">
                                                                    <table class="w20" cellspacing="0" cellpadding="0" border="0" align="center" width="25%" bgcolor="#ffffff" style="width: 25%; background-color: #0d7997; margin: 0 auto; text-align: center">
                                                                        <tbody>
                                                                            <tr>
                                                                                <td>
                                                                                    <a href="{{ url }}" style="padding: 8px 12px !important;background: #0d7997 !important;font-size: 14px !important;color: #ffffff !important;text-decoration: none !important;text-decoration: none;display: block !important;">Set your password</a>
                                                                                </td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
                            ...
                            <tr>
                                <td align="center" style="background: #fff;" ">
                                    <a href="{{ user.user_metadata.base_url }} " style="font-size: 14px !important;color: #0d7997 !important;text-decoration: none !important;text-decoration: none; ">Login with domain</a>
                                </td>
                            </tr>
                            <tr>
                                <td align="center " style="background: #fff; " ">
                                ...
                                <td>
                                    ...
                                    <table class="w100" cellspacing="0" cellpadding="0" border="0" align="center" width="100%" bgcolor="#ffffff" style="width: 20%; background-color: #ffffff; margin: 0 auto; text-align: center">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <h1 style="margin-bottom: 0;">Hello {{ user.email }},</h1>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <p>Tap the button below to set your new password</p>
