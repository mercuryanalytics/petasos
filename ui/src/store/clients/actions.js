...
export function getClients(userId) {
  ...
  return dispatch =>
    (!apiCall.isCalled(
      [`${Constants.API_URL}/clients${queryString}`].concat(!hasValue(userId) ? [`${Constants.API_URL}/clients`] : [])
    )
...
export function getClientsFromSA(userId) {
  ...
  return dispatch =>
    apiCall("GET", `${Constants.API_URL}/clients${queryString}`).then(
      res => dispatch(getClientsSuccess(res)),
      err => handleActionFailure(err, dispatch(getClientsFailure(err)))
    )
}
...
export function getClient(id, userId) {
  ...
  return dispatch =>
    (!apiCall.isCalled(
      [`${Constants.API_URL}/clients/${id}${queryString}`].concat(
        !hasValue(userId) ? [`${Constants.API_URL}/clients`] : []
      )
    )
...
export function createClient(data) {
  ...
  return dispatch => {
    return apiCall("POST", `${Constants.API_URL}/clients`, { body }).then(
...
export function updateClient(id, data) {
  const body = JSON.stringify({ client: data })
  return dispatch => {
    return apiCall("PATCH", `${Constants.API_URL}/clients/${id}`, { body }).then(
...
export function deleteClient(id) {
  return dispatch => {
    return apiCall("DELETE", `${Constants.API_URL}/clients/${id}`).then(
...
export function getTemplates(clientId) {
  return dispatch =>
    (!apiCall.isCalled([`${Constants.API_URL}/clients/${clientId}/templates`])
...
export function updateTemplate(clientId, data) {
  return dispatch => {
    return apiCall("POST", `${Constants.API_URL}/clients/${clientId}/templates`, { body: JSON.stringify(data) }).then(
...
export function getDomains(clientId) {
  return dispatch =>
    (!apiCall.isCalled([`${Constants.API_URL}/clients/${clientId}/domains`])
...
export function createDomain(data, clientId) {
  return dispatch => {
    return apiCall("POST", `${Constants.API_URL}/clients/${clientId}/domains`, { body: JSON.stringify(data) }).then(
...
export function updateDomain(id, data, clientId) {
  return dispatch => {
    return apiCall("PATCH", `${Constants.API_URL}/clients/${clientId}/domains/${id}`, {
...
export function deleteDomain(id, clientId) {
  return dispatch => {
    return apiCall("DELETE", `${Constants.API_URL}/clients/${clientId}/domains/${id}`).then(
