...
export function resetPassword(user, partner) {
  ...
  return dispatch => {
    return apiCall("POST", `${Constants.API_URL}/reset-password`, { body, noAuth: true }).then(
...
export function verifyPasswordToken(token) {
  ...
  return dispatch => {
    return apiCall("POST", `${Constants.API_URL}/verify-password-token`, { body, noAuth: true }).then(
...
export function resendPasswordToken(token, email) {
  ...
  return dispatch => {
    return apiCall("POST", `${Constants.API_URL}/resend-password-token`, { body, noAuth: true }).then(
...
export function changePassword(token, password, password_confirmation) {
  ...
  return dispatch => {
    return apiCall("POST", `${Constants.API_URL}/change-password`, { body, noAuth: true }).then(
