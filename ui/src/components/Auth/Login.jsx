      ...
      {(view === LoginViewTypes.Login && (
        <>
          ...
          <div className={styles.loginSection}>
            <Input className={styles.control} field={user} disabled={isBusy || submitting} label="Email" />
            <Input
          ...
          <>
            <div className={styles.resetSection}>
              <div className={styles.resetInfo}>
                <span>
                  {"Please enter the email used for your "}
                  <a href="https://www.researchresultswebsite.com">www.researchresultswebsite.com</a>
                  {" account and we will email you to reset your password."}
                </span>
              </div>
              <Input
                className={`${styles.control} ${styles.nopad}`}
        ...
        {(view === LoginViewTypes.Login && (
          ...
          (view === LoginViewTypes.Reset && (
            <>
              ...
              <Button transparent disabled={isBusy || submitting} onClick={() => switchView(LoginViewTypes.Login)}>
                <span>Cancel</span>
              </Button>
            </>
          ))}
