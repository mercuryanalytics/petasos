...
export const getLogo = async () => {
  ...
  if (partner) {
    return apiCall("GET", `${Constants.API_URL}/logo?subdomain=${partner}`, { noAuth: true }).then(res => res.logo)
  }
...
const App = () => {
  ...
  return (
    <Switch>
      ...
      <Route path={Routes.CreateClient} render={p => <Index {...p} content={ContentTypes.CreateClient} />} />
      <Route path={Routes.ManageClient} render={p => <Index {...p} content={ContentTypes.ManageClient} />} />
      <Route path={Routes.CreateProject} render={p => <Index {...p} content={ContentTypes.CreateProject} />} />
      <Route path={Routes.ManageProject} render={p => <Index {...p} content={ContentTypes.ManageProject} />} />
      <Route path={Routes.CreateReport} render={p => <Index {...p} content={ContentTypes.CreateReport} />} />
      <Route path={Routes.ManageReport} render={p => <Index {...p} content={ContentTypes.ManageReport} />} />
